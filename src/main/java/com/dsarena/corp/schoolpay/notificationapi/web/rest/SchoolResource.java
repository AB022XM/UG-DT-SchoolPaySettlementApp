...
/**
 * REST controller for managing {@link com.dsarena.corp.schoolpay.notificationapi.domain.School}.
 */
@RestController
@RequestMapping("/api")
public class SchoolResource {
     ...
     */
    @GetMapping("/schools")
    public ResponseEntity<List<SchoolDTO>> getAllSchools(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
